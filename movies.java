...
public class Movies {
  ...
  static int[][] ratings = Utils.data2Array(reader.load("C:\\Users\\Imani\\Desktop\\ratings1.csv")); // userId, movieId, rating
  static String[][] movieData = Utils.stringData2Array(reader.load("C:\\Users\\Imani\\Desktop\\movies.csv"));
  ...
  */
  ...
  /*
  * Method to find all ratings data for a particular movies
  * @param int movieId
  ...
  */
  ...
  /*
  * Method to find the average rating of a movies
  * @param int movieId
